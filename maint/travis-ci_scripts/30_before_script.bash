...
if [[ "$CLEANTEST" = "true" ]]; then
  ...
  parallel_installdeps_notest SQL::Abstract Moose Module::Install@1.15 JSON SQL::Translator File::Which Class::DBI::Plugin D/DJ/DJZORT/DBD-Oracle-1.75_42.tar.gz
